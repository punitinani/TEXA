...
<html>
    ...
    <body onload="onLoading()">
        ...
        <br> <ul class=" col-sm-2 ">
            <p><a href="<?php echo htmlentities("?showAll=" . base64_encode("ShowAllPunit")); ?>" class="list-group-item" style="background:  #E7E7E7 ;  list-style-type: none; font-family:Century Gothic   ; font-size: 1.2em;"> Show all </a></p>
