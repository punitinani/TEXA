    ...
    <body>
        ...
        <form role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <div>
                ...
                <a href="<?php echo htmlentities("index.php"); ?>" name="reset" id="set"  style="margin-left: 1%;"class="btn btn-danger"> Cancel   </a>
            </div>
            ...
            <div style="float:center;" id="set">
                ...
                <center >
                    <textarea id="area"  name="message" placeholder="Enter  your  text here......!!" autofocus><code><?php echo trim($detail['message']); ?> </code></textarea>   
                </center>
            </div>
        </form>
